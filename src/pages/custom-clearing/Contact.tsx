...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Adret Custom Clearing | GVANY"
        description="Get in touch with Adret for customs clearance, freight forwarding and logistics support in Africa."
        canonical="/custom-clearing/contact"
      />
      <div>
        <LyxHero page="contact" />

        <section className="section bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#0188F4]/5 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#FF7A00]/5 rounded-full blur-3xl" />
