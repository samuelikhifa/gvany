...
//   ]
  ...
  return (
    <>
      <SEO
        title="Our Services – GVANY"
        description="Explore all GVANY services: Marketing & Sales, Haulage & Logistics, Custom Clearing, Real Estate, Agro-Allied and Consultancy across Africa."
        canonical="/services"
      />
    <div>
      <Hero page="services" />
