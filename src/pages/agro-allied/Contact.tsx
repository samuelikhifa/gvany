                ...
                <div className="card">
                  <div className="p-8 md:p-10">
                    <div className="mb-8">
                      ...
                      >
                        Send Us a <span className="text-[#DA9E1B]">Message</span>
                      </h2>
                      <p
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <motion.button
                        ...
                        className={`btn -[text-[#DA9E1B]] w-full ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
...
export default AgroAlliedContact
