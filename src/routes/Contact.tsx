...
const Contact = () => {
  ...
  const offices = [
    ...
    },
    {
      ...
      city: 'Dakar',
      flag: '🇸🇳',
      phone: '+221 xxx xxx xxxx',
      email: 'senegal@gvany.com',
      type: 'Branch Office',
      color: '#8B5CF6'
    }
  ]
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/90">info@gvany.com</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/90">+234 xxx xxx xxxx</div>
                      </div>
                    </a>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/90">Lagos & Abuja, Nigeria</div>
                      </div>
                    </div>
                  </div>
                </div>
