          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-8 md:p-10 relative z-10">
                ...
                <div className="mt-6 flex items-center gap-2 text-[#01A5F9] font-semibold">
                  <span>Leading with Purpose</span>
            ...
            >
              ...
              <div className="p-8 md:p-10 relative z-10">
                ...
                <div className="mt-6 flex items-center gap-2 text-[#E56732] font-semibold">
